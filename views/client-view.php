            ...
            <section>
                ...
                <div class="view-container">
                    ...
                    <div class="view-buttons">
                        ...
                        <button class="order"><a href="?action=order-create&id=<?= $client->getIdClient() ?>">Ajouter une commande 🛒</a></button>
                        <button class="order"><a href="?action=order-list&id=<?= $client->getIdClient() ?>">Voir les commandes de ce client 🔎</a></button>
